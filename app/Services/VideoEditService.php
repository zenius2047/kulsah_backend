...
class VideoEditService
{
    ...
    private function applyVideoDurationFallback(Video $video, array $timeline): array
    {
        ...
        if (isset($timeline['project']) && is_array($timeline['project'])) {
            if (! array_key_exists('duration', $timeline['project']) || $timeline['project']['duration'] === null || $timeline['project']['duration'] === '') {
                $timeline['project']['duration'] = $duration;
            }
