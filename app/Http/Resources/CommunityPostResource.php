    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'viewer' => [
                ...
                'commented' => (bool) ($this->has_commented ?? false),
                'has_voted' => (bool) ($this->has_voted ?? false),
                'has_viewed' => (bool) ($this->has_viewed ?? false),
                'view_count' => (int) ($this->viewer_view_count ?? 0),
                'last_viewed_at' => optional($this->viewer_last_viewed_at)?->toIso8601String(),
                'completion_percentage' => (float) ($this->viewer_completion_percentage ?? 0),
                'reaction' => null,
